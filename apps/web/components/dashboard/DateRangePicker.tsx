...
const inputCls =
  "bg-[var(--bg-elevated)] text-[#DBC3AE]/90 text-xs rounded-lg px-2.5 py-1.5 border border-white/[0.08] focus:border-[#C08457] focus:outline-none [color-scheme:dark]";
    ...
    <div className={cn("flex flex-col gap-1.5", className)}>
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {active && (
          <button
            onClick={() => onChange({})}
            className="flex items-center gap-1 text-[11px] text-zinc-500 hover:text-[#DBC3AE]/75 border border-white/[0.08] rounded-lg px-2 py-1.5 transition-colors"
