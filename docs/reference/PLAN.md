...
| Milestone board page (admin-only): the six M1 criteria with live numbers — active days, experiments with outcomes, eval score, incidents, days since last critical incident | All                | The tracker lives in the product, so the month-6 review is a screen, not a spreadsheet |
...
| 22–25 | Milestone-1 evidence pack assembled from the Milestone board: usage report, experiments export with outcomes, eval run output, incident log, demo record                                                                                                                             | M1 review                                           |
...
| Criterion                                                                                            | Evidence on the Milestone board                                    | Target on 1 Mar 2027                                                                                                                       |
|------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
...
- **Monthly:** the Milestone board walked with Sandeep; his own usage and experiment numbers are on it, which is itself a nudge.
...
|----------------------------------------------------------------|---------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Sandeep doesn't form the daily habit                           | M1-2 fails regardless of engineering              | Brief comes to him; group view gives a group owner a reason; his numbers on the Milestone board; two possible 60-day windows before 1 Mar; ask Shourya to co-own the habit |
...
| Start date shifts                                              | Every date moves                                  | All dates are relative to Week 1; the Milestone board computes them from the agreed start                                                                                  |
